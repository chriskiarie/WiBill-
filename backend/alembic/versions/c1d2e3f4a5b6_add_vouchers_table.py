...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column('package_id',        postgresql.UUID(as_uuid=True), sa.ForeignKey('packages.id', ondelete='SET NULL'), nullable=True),
        ...
        sa.Column('price_ksh',         sa.Numeric(8, 2), nullable=False),
