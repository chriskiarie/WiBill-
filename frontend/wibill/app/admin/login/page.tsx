...
export default function AdminLogin() {
  ...
  useEffect(() => {
    const pre = searchParams?.get('username') || searchParams?.get('email');
    if (pre) setEmail(pre);
  ...
  return (
    <div style={{ minHeight: '100vh', background: C.void, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20, fontFamily: 'Inter, -apple-system, sans-serif' }}>
